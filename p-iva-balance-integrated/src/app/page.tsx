...
/**
 * Landing Page Component (Updated with Design System)
 * 
      ...
      <div className="container-app">
        <div className="pt-20 pb-16 text-center lg:pt-32">
          ...
          <div className="mx-auto max-w-6xl">
            <h1 className="heading-xl sm:text-6xl mb-8">
              P.IVA Balance
            </h1>
            <p className="text-lg leading-8 text-secondary max-w-4xl mx-auto mb-12">
            ...
            <div className="flex items-center justify-center gap-x-6">
              ...
              <Link
                href="/signup"
                className="text-base font-semibold leading-6 text-primary hover:text-brand-primary transition-colors"
              >
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col">
                <dt className="heading-sm">
                  <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-brand-primary mx-auto">
                ...
                <dd className="mt-1 flex flex-auto flex-col body-lg">
