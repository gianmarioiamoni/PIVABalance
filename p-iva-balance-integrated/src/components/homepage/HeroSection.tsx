...
export const HeroSection: React.FC<HeroSectionWithTrustProps> = ({
  ...
  return (
    <div className="content-medium">
      <h1 className="heading-xxl mb-8 animate-slide-up bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 bg-clip-text text-transparent">
        {title}
      </h1>
      
      <div 
        className="body-xl leading-relaxed content-wide mx-auto mb-12 animate-slide-up delay-200"
