...
donationSchema.statics.getMonthlyDonations = async function (
  year: number,
  month: number
) {
 ...
 */
export const Donation = (mongoose.models.Donation ||
  mongoose.model<IDonation>("Donation", donationSchema)) as IDonationModel;
